source "$HOME/.config/sketchybar/palette.sh"
source "$HOME/.config/sketchybar/typography.sh"
...
color_base() {
    ...
    export BLACK="${palette[0]}"
    export MAROON="${palette[1]}"
    export GREEN="${palette[2]}"
    export OLIVE="${palette[3]}"
    export NAVY="${palette[4]}"
    export PURPLE="${palette[5]}"
    export TEAL="${palette[6]}"
    export SILVER="${palette[7]}"
    export GREY="${palette[8]}"
    export RED="${palette[9]}"
    export LIME="${palette[10]}"
    export YELLOW="${palette[11]}"
    export BLUE="${palette[12]}"
    export FUCHSIA="${palette[13]}"
    export AQUA="${palette[14]}"
    export WHITE="${palette[15]}"
    export TRANSPARENT=0x00000000
}
...
color_semantic() {
    ...
    export TEXT_PRIMARY="$foreground"
    # export TEXT_PRIMARY="$WHITE"
    export TEXT_SECONDARY="$GREY"
    export TEXT_HIGHLIGHT="$selection_background"
    export ERROR="$RED"
    export SUCCESS="$GREEN"
    export INFO="$BLUE"
    export WARNING="$OLIVE"
    export ACCENT="$YELLOW"
    export CANVAS="$background"
    export BACKGROUND="$background"
    export BACKGROUND_HIGHLIGHT="$selection_background"
    export BORDER="${GREY}"
    export BORDER_HIGHLIGHT="$SILVER"
}
